...
class Group extends Box implements IItem {
    private var _items:Array<ISelect>;
    private var _selectHandler:Handler;
    private var _changeLabels:Handler;
    private var _selectedIndex:Int = -1;
    private var _skin:String;
    private var _labels:String;
    private var _labelColors:String;
    private var _labelStroke:String;
    private var _labelSize:Dynamic;
    private var _labelBold:Dynamic;
    private var _labelMargin:String;
