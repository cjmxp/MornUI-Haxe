...
class View extends Box {
    ...
    /**标准UI控件*/
    private static var uiClassMap(default, never):Dynamic={Box:Box,LayoutBox:LayoutBox,Group:Group,Button:Button,LinkButton:LinkButton,CheckBox:CheckBox,Clip:Clip,Image:Image,Label:Label,TextInput:TextInput,HSlider:HSlider,VScrollBar:VScrollBar,HScrollBar:HScrollBar};
